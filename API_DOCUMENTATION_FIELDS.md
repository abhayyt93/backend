...
### `POST /admin/updates`
- **Description**: Publish app updates dynamically.
- **Body Fields**:
  ```json
  {
    "title": "New Update",
...
- **Description**: Get app version configurations for all platforms.
- **Body Fields**: None

### `PUT /admin/app-config`
- **Description**: Create or update app version configuration.
- **Body Fields**:
  ```json
  {
    "platform": "android",
