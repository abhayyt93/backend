...
$instance_id = aws ec2 run-instances --image-id $ami_id --count 1 --instance-type t3.micro --security-group-ids $sg_id --user-data file://userdata.sh --query 'Instances[0].InstanceId' --output text
